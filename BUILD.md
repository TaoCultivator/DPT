...
| 最近路径 | 导出/打开目录由 QSettings 记住（注册表） |
...
```powershell
pyinstaller --noconfirm --windowed --name DPT_双脉冲参数提取工具_v1.1.5 --collect-all PyQt6 --collect-all pyqtgraph main.py
```
